...
if (isset($_POST["count_item"])) {
	...
	echo $row["count_item"];
	exit();
}//total envirionment variables for the full scope
//Count User cart item
							...
							echo
								'<input type="hidden" name="return" value="http://localhost/project1/payment_success.php"/>
									...
									<input style="float:right;margin-right:80px;" type="image" name="submit"
										...
										<input type="submit" href="#" class="btn btn-success" style="float:right;">
											<form action="test.php" method="post">

						</form>
								</form>';*/
								echo '
							<div class="col-xs-11 text-right"> <a href="test.php" class="btn btn-success btn-lg" >Continue Shopping</a> </div>
								';
