...
$unique = $today . $rand;
//$sql = "INSERT INTO `orders`( `user_id`, `product_id`, `qty`, `trx_id`, `p_status`) VALUES ('4','6','7','$unique','tyrytr')";
			//	mysqli_query($con,$sql);

		

				$trx_id = $unique /*$_GET["tx"]*/;
		$p_st = 'Completed' /*$_GET["st"]*/;
		$amt = $_GET["amt"];
		// $cc = $_GET["cc"];
		$cm_user_id = $_SESSION["uid"] /*$_GET["cm"]*/;
		// $c_amt = $_COOKIE["ta"];
	 ($p_st == "Completed");
...
//header("location:testsucces.php");
						...
						<div class="navbar navbar-inverse navbar-fixed-top">
							<div class="container-fluid">	
								<div class="navbar-header">
									<a href="#" class="navbar-brand">PyTeam</a>
								</div>
